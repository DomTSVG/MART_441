//=====================
// Stat Block Variables
//=====================

var playerLevel = getRandom();
console.log('Level: ' + playerLevel);

var playerHP = playerLevel * 3;
console.log('HP: ' + playerHP);

var playerDead = false;
console.log('Is player dead? ' + playerDead);

var playername = "Spirit";

// Call this when name in text needs to change
...
function changeName() {
  document.getElementById("intextname").innerHTML = playername;
}

// You Died function that turns your HP to zero.
function youDied() {
    if (playerDead = true) {
      for (h = playerHP; h >= 0; h--) {
        document.getElementById("hitpoints").innerHTML = h;
        document.getElementById("hitpoints").style.color = "red";
      }
    }
  }
//=========================
// End Stat Block Variables
//=========================
...
function getName() {
  ...
  document.getElementById("playername").style.color = "black";
  document.getElementById("playerlvl").style.color = "black";
  document.getElementById("hitpoints").style.color = "black";
  document.getElementById("inputname").style.display = "none";
  document.getElementById("submit").style.display = "none";
  document.getElementById("playerlvl").innerHTML = playerLevel;
  document.getElementById("hitpoints").innerHTML = playerHP;
  document.getElementById("statsetup").innerHTML = "Got it. And are you male or female?";
  document.getElementById("intextname").innerHTML = playername;
  document.getElementById("male").style.visibility = "visible";
  document.getElementById("female").style.visibility = "visible";

  if (playerLevel >= 10) { // ~~Changes the player's level to gold should it be over 10, for fun~~ //
    document.getElementById("playerlvl").style.color = "gold";
  }
}
// =============================
// Button input to select gender
// =============================
function getGender(gender) {
  if (gender == 1){
    document.getElementById("playerimg").innerHTML = "<img src=\"./images/player_m.gif\" alt=\"The Player\">";
    document.getElementById("male").style.display = "none";
    document.getElementById("female").style.display = "none";
    document.getElementById("statsetup").style.display = "none";
    document.getElementById("article").style.visibility= "visible";
  }

  else if (gender == 2) {
    document.getElementById("playerimg").innerHTML = "<img src=\"./images/player_f.gif\" alt=\"The Player\">";
    document.getElementById("male").style.display = "none";
    document.getElementById("female").style.display = "none";
    document.getElementById("statsetup").style.display = "none";
    document.getElementById("article").style.visibility= "visible";
...
function storyFunction(choice) {
  ...
  if (choice == 1 && answer1 == "Charity") {
    ...
    document.getElementById("story").innerHTML = "<p>Using your bulging muscles and sheer grit, you grab onto the sword and hang on for dear life! You wrestle with it for a good while, until eventually the sword manages to calm itself down. As you hold it tightly in your hands, it's like you can feel how it feels. And man, it's thinking 'How did I manage to get tamed by <span id=\"intextname\">this person</span>? This sucks.'</p><p>Certain enough that you'll get along eventually, you continue your climb until you find yourself at the peak of the stairs... The gates to Valhalla shine brightly and you step through, ready to enjoy paradise.</p><p>... or is that really how your story ended? You can always go back and try again...</p>";
    ...
    document.getElementById("badchoice").innerHTML = "Nah, I'm good.";
    let playerDead = true;
    console.log('Is player dead now? ' + playerDead);
    youDied();
  }
    ...
    document.getElementById("story").innerHTML = "<p>\"Howdy <span id=\"intextname\">friend</span>, and welcome to the afterlife!\"</p><p>You feel your senses coming back to you and your eyes open to a clear blue sky and clouds above and below you. Your head hurts like a bad hangover and your entire body aches distantly, which is to say your body <b>should</b> be aching, but it's not. You cast a quick glance down at yourself and you're but a shadow of your former self, a spirit!</p><p>You pick yourself up (or rather, you float yourself up) and face down a wispy looking person carrying a clipboard and wearing a funky hat. Your mind starts to clear a bit and he speaks up again.</p><p>\"So, you're dead, that much must be obvious to you at this point.\" He taps his finger-analogue (seriously, he doesn't even look like he has any) against his pen as he goes over the board. \"Problem is, our watcher was off on break while you bit the dust so we have no idea what you were just doing.\"</p><p>He looks up at you expectantly. \"So pal, what were you doing before you died just now?\"</p>";
    ...
    changeName();
    //=========================================================
    //This block here will reset the HP
    //=========================================================
    document.getElementById("hitpoints").innerHTML = playerHP;
    document.getElementById("hitpoints").style.color = "black";
    //==========================================================
